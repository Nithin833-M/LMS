    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>{courseData.educator.name}</span>
          </p>

          <div className='pt-8 text-gray-800'>
            <h2 className='text-x1 font-semibond'>Course Structure</h2>
            <div className='pt-5'>
              {courseData.courseContent.map((chapter, index)=> (
                <div key={index} className='border border-gray bg-white mb-2 rounded'>
          ...
          <div className='py-20 text-sm md:text-default'>
            <h3 className='text-xl font-semibond text-gray-800'>Course Description </h3>
...

        {
          ...
          <div className='flex gap-3 items-center pt-2'>
            <p className='text-gray-800 md:text-4xl text-2xl font-semibond'>{currency}{(courseData.coursePrice - courseData.discount * courseData.coursePrice / 100).toFixed(2)}</p>
          ...
          <div className='pt-6'>
            ...
            <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
              ...
              <li>Certifiacte of Completion.</li>
            </ul>
          </div>
